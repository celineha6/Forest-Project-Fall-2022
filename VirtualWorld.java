...
public final class VirtualWorld extends PApplet {
    ...
    */
    ...
    public void mousePressed() {
        ...
        Optional<Entities> entityOptional = Functions.getOccupant(world, pressed);
        if (entityOptional.isPresent()) {
            Entities entity = entityOptional.get();
    ...
    public void shiftView(int colDelta, int rowDelta) {
        int newCol = this.view.viewport.clamp(this.view.viewport.getcol() + colDelta, 0, this.world.getnumcols()- this.view.viewport.getnumCols());
        int newRow = this.view.viewport.clamp(this.view.viewport.getrow() + rowDelta, 0, this.world.getnumrows() - this.view.viewport.getnumRows());

        this.view.viewport.shift(newCol, newRow);
    }
    ...
    public void scheduleActions(WorldModel world, EventScheduler scheduler, ImageStore imageStore)
    {
        for (Entities entity : world.getentities()) {
            ...
            if (entity instanceof EntityActivityAction) {
                entity.scheduleAction((EntityActivityAction) entity, world, imageStore, scheduler);
            }
